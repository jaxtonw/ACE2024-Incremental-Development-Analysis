...
def main():
    ...
    while playAgain:
        ...
        if mode == 1:
            ...
            centerX = eval(input("Center X position: "))
            centerY = eval(input("Center Y position: "))
            offset = eval(input("Offset Value: "))
            width = eval(input("Width Value: "))
            height = eval(input("Height Value: "))                        
            count = eval(input("Count Value: "))
        ...
        # If they choose 'Super Patterns'
            ...
            #### Add Input Statement(s) as needed ####
            num = input("How many patterns would you like to create? ")
            #### End Add Inputs Statement(s) ####
            if num == "":
