...
def binarySearch(inputList, key):
    ...
    return binarySearchRecurse(inputList, key, low, high)


def binarySearchRecurse(inputList, key, low, high):
    mid = (low + high) // 2
    ...
    if key == inputList[mid]:
        ...
        count += 1
        return binarySearchRecurse(inputList, key, low, mid - 1)
    else:
        count += 1
        return binarySearchRecurse(inputList, key, mid + 1, high)
