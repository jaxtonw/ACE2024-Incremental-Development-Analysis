...
def main():
    ...
    while not done:
      ...
      #      break
        ...
        print()
        # Check to see if the Blobber turned to dust while waiting for the user to 
#make a selection
       # vitals, blobberOK = myBlobber.vitalsOK()
     #   if not blobberOK:
      #      print("Your Blobber is at " + format(vitals, ".2%") + " happiness")
