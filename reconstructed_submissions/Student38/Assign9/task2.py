...
def displayName(blobber):
    print("Your Blobber's name is " + str(Blobber.displayName(blobber)))

def changeName(blobber):
    name = input("Enter Blobber's new name: ")
    Blobber.changeName(blobber, name)
    displayName(blobber)

def displayColor(blobber):
    print("Your Blobber's color is " + str(Blobber.displayColor(blobber)))

def changeColor(blobber):
    color = input("Enter Blobber's new color: ")
    Blobber.changeColor(blobber, color)
...
def blobberSpeak(blobber):
    print(str(Blobber.blobberSpeak(blobber)))
