...
# Really confused in general about this task, and I have enough assignment grace
# points to keep me at a higher A, so this is definitely unfinished
...
def displayHand(hand):
    print(playerHand) # Not a single line. The entire function body
