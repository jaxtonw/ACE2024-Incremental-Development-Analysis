...
def main():
    ...
    # Set loop to continue running program
    while not done:
        print()
        print("Main Menu")
...
# Define functions that handle the name and color, feeds the Blobber, and makes the Blobber speak
...
def changeName(blobber):
    ...
    blobber.setName(name.capitalize())
    displayName(blobber)
